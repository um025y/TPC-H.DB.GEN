...
## Generating random zipf distribution values for min. and max. range and storing them to the empty arrays declared above.
    ...
    lineitem_ext_price1_list.append(min_range_value)
    lineitem_ext_price2_list.append(max_range_value)
    order_total_price1_list.append(min_range_value)
    order_total_price2_list.append(max_range_value)
    orderkey1_list.append(min_range_value)
    orderkey2_list.append(max_range_value)
...
results1.to_csv(r'D:\UofG\Results_1_Zipf\SQL_QUERY_LINEITEM_1_SHIPDATE_ZIPF.csv', index=False)
...
results2.to_csv(r'D:\UofG\Results_1_Zipf\SQL_QUERY_ORDER_1_ORDERDATE_ZIPF.csv', index=False)
...
results3.to_csv(r'D:\UofG\Results_1_Zipf\SQL_QUERY_LINEITEM_1_EXTENDEDPRICE_ZIPF.csv', index=False)
...
results4.to_csv(r'D:\UofG\Results_1_Zipf\SQL_QUERY_ORDER_1_TOTALPRICE_ZIPF.csv', index=False)
...
results5.to_csv(r'D:\UofG\Results_1_Zipf\SQL_QUERY_LINEITEM_1_ORDERKEY_ZIPF.csv', index=False)
...
results6.to_csv(r'D:\UofG\Results_1_Zipf\SQL_QUERY_ORDER_1_ORDERKEY_ZIPF.csv', index=False)
...
results7.to_csv(r'D:\UofG\Results_1_Zipf\SQL_QUERY_JOIN_ORDER_1_ORDERDATE_ZIPF.csv', index=False)
...
results8.to_csv(r'D:\UofG\Results_1_Zipf\SQL_QUERY_JOIN_ORDER_1_ORDERKEY_ZIPF.csv', index=False)
...
results9.to_csv(r'D:\UofG\Results_1_Zipf\SQL_QUERY_JOIN_ORDER_1_TOTALPRICE_ZIPF.csv', index=False)
...
results10.to_csv(r'D:\UofG\Results_1_Zipf\SQL_QUERY_JOIN_LINEITEM_1_ORDERKEY_ZIPF.csv', index=False)
...
results11.to_csv(r'D:\UofG\Results_1_Zipf\SQL_QUERY_JOIN_LINEITEM_1_SHIPDATE_ZIPF.csv', index=False)
...
results12.to_csv(r'D:\UofG\Results_1_Zipf\SQL_QUERY_JOIN_LINEITEM_1_EXTENDEDPRICE_ZIPF.csv', index=False)
...
time_data_df.to_csv(r'D:\UofG\Results_1_Zipf\TIME_CALCULATIONS_1_ZIPF.csv', index=False)
